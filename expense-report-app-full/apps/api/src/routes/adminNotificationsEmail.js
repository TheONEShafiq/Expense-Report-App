...
adminNotificationsRouter.get("/email-config", async (req, res) => {
...
adminNotificationsRouter.put("/email-config", async (req, res) => {
...
adminNotificationsRouter.post("/email/test", async (req, res, next) => {
  try {
