...
async function loadCompanies(){ const j = await fetchJSON('/admin/companies'); els.company.innerHTML = j.data.map(c => `<option value="${c.id}">${c.name}</option>`).join(''); }
